...
<html>
 <head>
  <link rel="shortcut icon" href="img/HomeLogo.jpg" />
 ...
 <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">AttendanceMate</a>
        </div>
  ...
  <div class="container">
    <h2>For Students</h2>
    <h4>Click here for <a href="student.php">Student Dashboard and Student Login</a></h4>
    <hr>
    <h2>For Faculty Dashboard and Faculty Login
    </h2>
